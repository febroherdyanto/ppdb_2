...
<!-- ./lainnya -->
                ...
                <h2>Siswa diterima di Jurusan TSM</h2>
            </div>
        </div><!--pageheader-->
    ...
    <?php
    $tampil=mysqli_query($koneksi,"SELECT * FROM g2_bio_siswa WHERE jurusan='TSM' AND diterima='Y' ORDER BY rata_total DESC LIMIT 90");
